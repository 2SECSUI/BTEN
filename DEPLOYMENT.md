...
- Current package (v13): `0x646612b6c4c040bfae0e7d519fc5ef6bc0f1555502d5f8136d08e59ede2c0191`
...
V13 was deployed in transaction `Gv6ofDX7Lme9D443rdRHvbPGhoofMhDQxtmN8xJhwadQ` with verified dependencies. It adds one-sided, adjacent-price Cetus LP executors for both BTEN token orderings. The LP programme was created and finalized in `CwYCyR6QrGXmqFckXdJkQfxKHdQ7tqpG78RByaJcgfFQ` and `7WHWwJycSpYp4iAHT5Fu1RV5uU7EZNs6GPn2JDs7AU3o`. The original protocol-owned BTEN/SUI liquidity deployment succeeded in `GoQEemf9qTnFG1uXkbPt5grPn1frYWRbEL6K4HTW7rBm`; V13 subsequently deployed the remaining 40 BTEN as one-sided, price-adjacent positions across the ten finalized allowlisted pools. Exact pool and position IDs are in `MAINNET_ROUTE_CONFIG.json`. Configure the Block10 dapp from `config/block10_integration.json`, keep sponsorship disabled for the wallet-paid phase, and only then consider package immutability.
